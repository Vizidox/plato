...
from .jinja_formatters import format_year, format_month, num_to_ordinal, of_month_year, format_dates, nth
...
FORMATTERS = [format_year, format_month, num_to_ordinal, of_month_year, format_dates, nth]